...
//===== クラス関数の実装 =====
bool MyCollision::CheckCollisionRectToRect(float PosX1, float PosY1, float PosX2, float PosY2, float width1, float height1, float width2, float height2)
{
...
bool MyCollision::CheckCollisionRectToRect(myRECT rect1, myRECT rect2)
{
...
bool MyCollision::CheckCollisionCircleToCircle(float PosX1, float PosY1, float PosX2, float PosY2, float radius1, float radius2)
{
...
bool MyCollision::CheckCollisionCircleToCircle(myCIRCLE c1, myCIRCLE c2)
{
...
bool MyCollision::CheckCollisionPointToRect(float PointX, float PointY, float RectPosX, float RectPosY, float width, float height)
{
...
bool MyCollision::CheckCollisionPointToRect(myRECT rect, float posX, float posY)
{
